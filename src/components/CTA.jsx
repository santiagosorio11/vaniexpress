    ...
    <section className="relative py-24 px-4 overflow-hidden bg-slate-900">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <a href="https://wa.me/573000000000?text=¡Hola!%20Quiero%20planear%20un%20viaje%20con%20Vaniexpress" target="_blank" rel="noreferrer" className="bg-primary hover:bg-secondary text-white w-full sm:w-auto px-10 py-5 rounded-full font-bold text-lg shadow-[0_0_30px_rgba(14,165,233,0.3)] hover:shadow-[0_0_40px_rgba(14,165,233,0.5)] hover:-translate-y-1 transition-all flex items-center justify-center gap-3">
